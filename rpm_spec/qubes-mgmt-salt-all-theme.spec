...
qubesctl top.enable %{state_name}.fonts_ubuntu saltenv=all -l quiet --out quiet > /dev/null || true
qubesctl top.enable %{state_name}.fonts_source_code_pro saltenv=all -l quiet --out quiet > /dev/null || true
