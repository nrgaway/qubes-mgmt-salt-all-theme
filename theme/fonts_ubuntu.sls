...
$with /usr/share/fonts/ubuntu-font-family:
  ...
  $if grains('os') == 'Fedora':
    ttmkfdir -o /usr/share/fonts/ubuntu-font-family/fonts.scale -d /usr/share/fonts/ubuntu-font-family > /usr/share/fonts/ubuntu-font-family/fonts.dir && fc-cache -fv:
      cmd.run: 
        - creates: 
